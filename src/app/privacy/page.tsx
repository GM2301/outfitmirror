      ...
      <section className="px-4 pb-20 max-w-2xl mx-auto">
        ...
        <Section title="What we collect">
          <ul className="list-disc pl-5 space-y-1.5">
            <li><strong>Account info:</strong> email address, and name/profile photo if you sign in with Google.</li>
            ...
            <li><strong>Location:</strong> only if you enable weather-aware outfits — we request your device's coordinates to fetch a local forecast. This is never stored on our servers beyond what's needed to show current weather; Trip Planner uses a destination city you type in, not your location.</li>
